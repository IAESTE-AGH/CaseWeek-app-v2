...
export const WORKSHOPS_MOCKS: Workshop[] = [
  {
    ...
    company: {
      ...
      shortDescription:
        "Tech Solutions Inc. is a leading provider of software solutions.",
      longDescription:
    ...
    shortDescription:
      "Learn the fundamentals of data science and its applications in real-world scenarios.",
    longDescription:
    ...
    propositions: {
      id: [
        ...
        "89089d1a-b4ac-4d45-bb8f-69a8d1d90d4c",
        "cde99e9a-8b72-4c8f-bc29-7e7cf456b890",
      ],
    },
  },
  {
    ...
    shortDescription:
      "Discover the principles of machine learning and its practical applications.",
    longDescription:
    ...
    preferableFieldsOfStudy: [
      ...
      {
        id: "c827a3a0-8f32-499d-9f9c-1ec6e90ff775",
  ...
  },
  {
    ...
    company: {
      ...
      shortDescription:
        "Tech Academy offers comprehensive tech education programs.",
      longDescription:
    ...
    shortDescription:
      "Master the skills required to build modern web applications.",
    longDescription:
  ...
  },
  {
    ...
    company: {
      ...
      shortDescription:
        "Data Solutions Ltd. specializes in data management and analytics.",
      longDescription:
    ...
    shortDescription:
      "Master advanced SQL techniques for efficient data manipulation and analysis.",
    longDescription:
  ...
  },
  {
    ...
    company: {
      ...
      shortDescription:
        "AI Innovations Inc. pioneers in artificial intelligence research and development.",
      longDescription:
    ...
    shortDescription:
      "Explore the fascinating world of natural language processing and its applications.",
    longDescription:
  ...
  },
  {
    ...
    company: {
      ...
      shortDescription:
        "TechHub provides a platform for tech enthusiasts to collaborate and innovate.",
      longDescription:
    ...
    shortDescription:
      "Discover the fundamentals of blockchain technology and its potential applications.",
    longDescription:
  ...
  },
  {
    ...
    company: {
      ...
      shortDescription:
        "CodeCrafters Ltd. specializes in coding education and training.",
      longDescription:
    ...
    longDescription:
      "This workshop covers Python basics, data structures, control flow, and functions. Participants will work on coding exercises and projects to reinforce learning.",
    ...
    preferableFieldsOfStudy: [
      ...
      {
        id: "7q8r9s0t-u1v2-w3x4-y5z6-1a2b3c4d5e6f",
        name: "Information Technology",
      },
    ],
    propositions: {
  ...
  },
  {
    ...
    company: {
      ...
      shortDescription:
        "TechGenius Solutions offers innovative tech solutions and consulting services.",
      longDescription:
    ...
    shortDescription:
      "Explore cybersecurity threats and best practices to secure digital assets.",
    longDescription:
  ...
  },
  {
    ...
    company: {
      ...
      shortDescription:
        "InnovateTech Labs is dedicated to fostering innovation and technological advancement.",
      longDescription:
    ...
    shortDescription:
      "Explore the exciting world of the Internet of Things and its applications.",
    longDescription:
      "This workshop covers IoT concepts, protocols, sensor networks, and IoT platforms. Participants will learn to build IoT applications and prototypes.",
    ...
    preferableFieldsOfStudy: [
      {
        id: "98765432-1010-9876-5432-109876543210",
